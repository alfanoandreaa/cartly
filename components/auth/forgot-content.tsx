    ...
    <main className="grid min-h-screen lg:grid-cols-2">
      <section className="flex min-h-screen flex-col px-5 py-6 sm:px-10 lg:px-16">
        ...
        <div className="my-auto mx-auto w-full max-w-md py-12">
          <p className="text-sm font-semibold text-lime">{t("auth.forgotEyebrow")}</p>
          <h1 className="mt-2 text-4xl font-bold tracking-tight">{t("auth.forgotTitle")}</h1>
          <p className="mt-3 text-muted">{t("auth.forgotSubtitle")}</p>
          <ForgotPasswordForm />
