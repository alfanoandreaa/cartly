    ...
    <main className="grid min-h-screen lg:grid-cols-2">
      <section className="flex min-h-screen flex-col px-5 py-6 sm:px-10 lg:px-16">
        ...
        <div className="my-auto mx-auto w-full max-w-md py-12">
          ...
          <p className="mt-3 text-muted">Five picks are on us. No card, no pressure, no clutter.</p>
        ...
        <div className="mx-auto max-w-lg">
          <div className="rounded-[32px] border border-line bg-card p-8 shadow-card">
            ...
            <div className="mt-8 space-y-5">
              {["Five active product picks", "Three organized collections", "Daily price and stock checks", "Notes, tags, and priorities"].map((feature) => (
